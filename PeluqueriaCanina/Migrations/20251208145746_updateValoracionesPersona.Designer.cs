...
namespace PeluqueriaCanina.Migrations
{
    ...
    [Migration("20251208145746_updateValoracionesPersona")]
    partial class updateValoracionesPersona
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeluqueriaCanina.Models.Grupos.Grupo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrupoUsuario", b =>
                {
                    b.HasOne("PeluqueriaCanina.Models.Grupos.Grupo", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PeluqueriaCanina.Models.ClasesDeCliente.Mascota", b =>
                {
                    b.HasOne("PeluqueriaCanina.Models.Users.Persona", "Cliente")
                        .WithMany("Mascotas")
            ...
            modelBuilder.Entity("PeluqueriaCanina.Models.ClasesDeCliente.Valoracion", b =>
                {
                    ...
                    b.HasOne("PeluqueriaCanina.Models.Users.Persona", "Peluquero")
